...
if [ "$#" -ne 3 ]; then
	echo "Usage: masscan.sh <rate - pps> <targets file> <output file basename>"
	exit 1
fi
...
TARGETSFILE=$2
OUTPUTBASE=$3
PORTLIST="1,3,7,9,13,17,19,21-23,25-26,37,53,79-82,88,100,106,110,111,113,119,135,139,143-144,179,199,254,255,280,311,389,\
